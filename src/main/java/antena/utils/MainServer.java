...
public class MainServer {
	final static ModelEmpresario modelEmpr = new ModelEmpresario();
    ...
    public static void initializeControllerEmpresario() {
    	ControllerEmpresario controller = new ControllerEmpresario(modelEmpr); 
